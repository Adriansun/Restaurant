...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:comment>
		...
		<html>
			<head>
				<title>Apple-Cinnamon Shortcakes recipe</title>
				...
				<xsl:for-each select="reml/webpageauthordata">
				  ...
				  <li>
					...
					<figure>
						...
						<figcaption>Apple-Cinnamon Shortcakes Recipe photo by Taste of Home</figcaption>
					</figure>
					<h2>Ingredients</h2>
					<table border="1">
						<tr>
					...
					<br/>
					<a href="../../recommendations/recommendations_Apple-Cinnamon_Shortcakes.php">Similar to this recipe</a>
					<hr/>
					<h2>Facts</h2>
					<ul>
