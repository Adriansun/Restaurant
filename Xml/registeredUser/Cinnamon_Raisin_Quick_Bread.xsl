...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:comment>
		...
		<html>
			<head>
				<title>Cinnamon Raisin Quick Bread recipe</title>
				...
				<xsl:for-each select="reml/webpageauthordata">
				  ...
				  <li>
					...
					<figure>
						...
						<figcaption>Cinnamon Raisin Quick Bread Recipe photo by Taste of Home</figcaption>
					</figure>
					<h2>Ingredients</h2>
					<table border="1">
						<tr>
					...
					<br/>
					<a href="../../recommendations/recommendations_Cinnamon_Raisin_Quick_Bread.php">Similar to this recipe</a>
					<hr/>
					<h2>Facts</h2>
					<ul>
