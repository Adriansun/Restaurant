				...
				<xsl:for-each select="reml/webpageauthordata">
				  ...
				  <li>
					...
					<figure>
						...
						<figcaption>Morning Cinnamon Rolls Recipe photo by Taste of Home</figcaption>
					</figure>
					<h2>Ingredients</h2>
					<table border="1">
						<tr>
					...
					<br/>
					<a href="../../recommendations/recommendations_Morning_Cinnamon_Rolls.php">Similar to this recipe</a>
					<hr/>
					<h2>Facts</h2>
					<ul>
